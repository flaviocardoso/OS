...
<div class="wrapper">
    ...
    <nav id="sidebar" side-bar>
        ...
        <div class="sidebar-header">
            <a href="https://os.cbpf.br/"><h3>Ordem de Serviço</h3></a>
        </div>
        <ul class="list-unstyled components py-0">
            <li>
                <a href="" data-target="#adminSubmenu" data-toggle="collapse" class="btn-success" aria-expanded="true">Adminstração</a>
    ...
    <nav id="navmenu" class="navbar navbar1 navbar-expand-lg navbar-light bg-light px-2 py-1">
        	<div class="container-fluid px-0">
                ...
                <button ng-model="btnid" class="btn btn-lg btn-outline-success font-weight-bold text-left border-0" disabled>
                    <span class="nomePrefil">{{dataNome}}</span>
                </button>
        		<button class="btn btn-info dropdown-toggle1 dropdown-toggle" type="button" data-toggle="dropdown" id="navbarSupportedContent" aria-haspopup="false" aria-expanded="false">
            		<i class="fas fa-ellipsis-v fa-3x"></i>
        		</button>

        		<div class="dropdown-menu dropdown-menu-right bg-light shadow p-3 mb-3 rounded" aria-labelledby="navbarSupportedContent">
