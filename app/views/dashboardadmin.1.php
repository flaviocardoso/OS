...
<div class="wrapper">
    ...
    <nav id="sidebar" side-bar>
        ...
        <ul class="list-unstyled components">
            <p>Adminstração</p>
            <li>
                <a href="" data-target="#adminFunction" data-toggle="collapse" class="btn btn-success" aria-expanded="true">Funções Adminstrativas</a>
                <ul class="collapse list-unstyled components" id="adminFunction">
                    <li>
