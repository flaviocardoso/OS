<div class="navbar w-100 my-1" id="painelmenu">
    <span ui-sref="dashboard.os.ver.editadalaudoverencerrada" class="float-left rounded-circle"><i class="fas fa-angle-left fa-3x"></i></span>
...
<div views-tecnico idos="$ctrl.osid.id_os" num="$ctrl.osid.n_os" status="$ctrl.osid.status" coord="$ctrl.osid.dest_coord" setor="$ctrl.osid.dest_setor" area="$ctrl.osid.dest_area" pag="editada"></div>
        ...
        <div class="collapse" id="collapseActions">
            <div class="row">
                <div class="col mx-auto py-2 text-center">
                    <button laudo-select class="btn btn-block" type="button" data-toggle="modal" data-target="#renovarorderservice">RENOVAR</button>
                </div>
                <div class="w-100"></div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="renova" novalidate>
                        <div class="form-group">
                            <label for="idJust">Você quer Renovar está Ordem de Serviço?</label>
                            <textarea ng-model="renovajust" id="idJust" class="form-control"></textarea>
                            <small class="form-text text-muted">Escreva uma justificativa para a Renovação desta Ordem de Serviço.</small>
                        </div>
                        <div class="form-group">
                            <small id="renovaHelp" class="form-text text-muted">Confirme</small>
                            <input type="checkbox" ng-model="renovaOrdem" id="idrenova" required>
                            <label for="idrenova">SIM</label>
                        </div>                        
                    </form>                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                    <button type="button" class="btn btn-primary" laudo-renova-ordem idos="$ctrl.osid.id_os" setor="$ctrl.osid.dest_setor" area="$ctrl.osid.dest_area" confcheck="renovaOrdem" motivo="renovajust" ng-disabled="renova.$invalid">Renovar</button>
                </div>
            </div>
        </div>
    </div>
