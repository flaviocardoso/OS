<div class="navbar w-100 my-1" id="painelmenu">
    <span ui-sref="dashboard.os.ver.enviadaverencerradaadmin" class="float-left rounded-circle"><i class="fas fa-angle-left fa-3x"></i></span>
...
<div views-tecnico idos="$ctrl.osid.id_os" num="$ctrl.osid.n_os" status="$ctrl.osid.status" coord="$ctrl.osid.dest_coord" setor="$ctrl.osid.dest_setor" area="$ctrl.osid.dest_area" pag="enviada"></div>
