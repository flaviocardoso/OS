<div class="navbar w-100 my-1" id="painelmenu">
    <span ui-sref="dashboard.os.ver.recebidaversecrencerrada" class="float-left rounded-circle"><i class="fas fa-angle-left fa-3x"></i></span>
...
<div views-tecnico idos="$ctrl.osid.id_os" num="$ctrl.osid.n_os" status="$ctrl.osid.status" coord="$ctrl.osid.dest_coord" setor="$ctrl.osid.dest_setor" area="$ctrl.osid.dest_area" pag="recebida"></div>
        ...
        <div class="collapse" id="collapseActions">
            <div class="row">
                <div class="col mx-auto py-2 text-center">
                    <button class="btn btn-block" type="button" data-toggle="modal" data-target="#renovarorderservice">RENOVAR</button>
                </div>
                <div class="w-100"></div>
            </div>
        </div>
