<div class="navbar w-100 my-1" id="painelmenu">
    <span ui-sref="dashboard.os.ver.recebidaversecrespera" class="float-left rounded-circle"><i class="fas fa-angle-left fa-3x"></i></span>
        ...
        <div class="collapse" id="collapseActions">
            <div class="row">
                <div class="col mx-auto py-2 text-center">
                    <button class="btn btn-block" type="button" data-toggle="modal" data-target="#ativarorderservice">TIRAR DA ESPERA</button>
                </div>
                <div class="w-100"></div>
            </div>
        </div>
