<div class="navbar w-100 my-1" id="painelmenu">
    <span ui-sref="dashboard.os.ver.solicverencerrada" class="float-left rounded-circle"><i class="fas fa-angle-left fa-3x"></i></span>
...
<div clear-notification id="$ctrl.osid.id_os"></div>
