...
<div class="painel-action">
    <div>
        <input type="checkbox" ng-model="action" id="actiondata">
        <label for="actiondata">Acões</label>
    </div>
    <div ng-show="action">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" ng-andamento onclick="this.disabled=true;" ng-disabled="runorderservice.$invalid">Andamento</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="painel-tecnico" last-laudo ng-model="$ctrl.osid.id_os">
    <div ng-if="(laudos.length > 0)" ng-repeat="l in laudos track by $index"> <!-- ng-repeat para demais laudos feitos pela atual ordem de serviços em andamento {{$ctrl.os_id}} o id abre os laudos escritos na ordem de serviço-->
        <hr>
