    ...
    angular.module('toaster', []).constant(
        ...
        'toaster', [
            '$rootScope', 'toasterConfig', function($rootScope, toasterConfig) {
                ...
                this.pop = function(type, title, body, timeout, positionClass, bodyOutputType, clickHandler, toasterId, showCloseButton, toastId, onHideCallback) {
                ...
                function createTypeMethod(toasterType) {
                    return function(title, body, timeout, positionClass, bodyOutputType, clickHandler, toasterId, showCloseButton, toastId, onHideCallback) {
